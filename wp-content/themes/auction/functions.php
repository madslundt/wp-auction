...
if ( ! function_exists( 'auction_setup' ) ) :
/**
...
function auction_setup() {
	...
	register_nav_menus( array(
		'guest' => __( 'Guest Menu', 'auction' ),
        'user'  => __('User Menu', 'auction'),
        'admin' => __('Administrator Menu', 'auction')
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'auction_custom_background_args', array(
...
function auction_scripts() {
	...
	wp_enqueue_script( 'auction-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
    ...
    wp_register_style( 'auction-custom-style', get_template_directory_uri() . '/css/style.css');
    wp_enqueue_style( 'auction-custom-style' );
